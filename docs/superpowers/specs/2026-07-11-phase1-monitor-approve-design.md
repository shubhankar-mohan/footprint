...
| D7 | **Swift app scaffolded as a full Xcode project** | `MenuBarExtra`, `UserNotifications`, Login Items, and an eventual bundle all work out of the box. (Full Xcode is a prerequisite — see §8.) |
